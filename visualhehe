...
local function SGDPWCW_fake_script() -- Dots.Dots 
...
coroutine.wrap(SGDPWCW_fake_script)()
local function FYJBOCX_fake_script() -- MainFrame.Manager 
...
coroutine.wrap(FYJBOCX_fake_script)()
local function ABZQOZ_fake_script() -- Percentage.Percentage 
...
coroutine.wrap(ABZQOZ_fake_script)()
local function GDRKAHH_fake_script() -- Tip.Tips 
	...
	while true do
		wait(5)
		tip.Text = "Script Version: 2.3.1"
		wait(5)
		tip.Text = "Script Made By Tree1"
		wait(5)
		tip.Text = "hmmmmmmmmm.... idk what to put here"
	end
end
coroutine.wrap(GDRKAHH_fake_script)()
local function KSYTYAX_fake_script() -- Loading.DefaultUI 
...
coroutine.wrap(KSYTYAX_fake_script)()
